...
var vg_5 = "json/choropleth_plot.vg.json"; 
vegaEmbed("#choropleth_plot", vg_5).then(function (result) { 
    // Access the Vega view instance (https://vega.github.io/vega/docs/api/view/) as result.view 
}).catch(console.error);


var vg_6 = "json/population_pyramid.vg.json"; 
vegaEmbed("#population_pyramid", vg_6).then(function (result) { 
    // Access the Vega view instance (https://vega.github.io/vega/docs/api/view/) as result.view 
}).catch(console.error);
